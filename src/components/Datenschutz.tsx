  ...
  return (
    <div className="containerDatenschutz">
      ...
      <p>
        ...
        <br /> Wir setzen folgende(n) Hoster ein: <br />
        <br />
        GitHub, Inc.
        <br /> Betrifft: Datenschutz
        <br /> 88 Colin P Kelly Jr St
        <br /> San Francisco
        <br /> CA 94107 United States of America <br />
        Telefon: +1 877 448 4820
        <br /> E-Mail: privacy@github.com
        <br /> Webseite: https://github.com/
      </p>
      ...
      <p>
        ...
        <br />
        Telefon: +49 15738124461 <br />
        E-Mail: Braun-Johannes@outlook.de <br />
        <br />
